...
public class MyHangerGD : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int iter = 0; iter < 100; ++iter)
        {
            ...
            Vector3 dwdt = penalty * (pin_def - pin_goal) - mass * gravity;
            Vector3 dwdo = penalty * Vector3.Cross(rot * pin, pin_def - pin_goal) - mass * Vector3.Cross(rot * cog, gravity);
            // end of edit
            // -----------------------------------
